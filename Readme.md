...
The schemes itfself are desribed in the following publication:
...
- Call *calcTB.py* to compute the Berry connection for the different schemes. This script has the option to output human readible *wannier_tb.dat* files as well.
...
- Calculation of dielectric constant (complex, Drude model) or optical conductivity (complex, Lorentz) can be performed using *calcEpsilon.py* and *calcSigma.py* and visualzied using *visualizeEpsilon.py* and *visualizeSigma.py*.
